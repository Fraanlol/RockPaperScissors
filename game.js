...
window.onload = magicText = () => {
    if (textIndex < titleText.length) {
        ...
        instructionBtt.style.display='block';
...
function showInstructions(){
    ...
    instructionList();
    document.querySelector('.elements').style.display = 'initial';
}
...
function startGame(){
    ...
    document.querySelector('.playButtons').style.display = 'initial';
...
function winner(){
    if (playerScore == 5 || computerScore == 5){
        ...
        if (playerScore > computerScore){
            ...
            statusMessage.style.cssText = 'animation-play-state: paused; color:green !important;';
        } else {
            statusMessage.innerHTML = 'You\'ve lost'
            statusMessage.style.cssText = 'animation-play-state: paused; color:red !important;';
        }  
    }
...
function battleStart(playerSelection, computerPlay){
    ...
    if (playerSelection === computerPlay){
                ...
                computerChoice.innerHTML = `${computerPlay} spell`
